...
var $author$project$Main$PropertiesReceived = function (a) {
	return {$: 'PropertiesReceived', a: a};
};
var $author$project$Main$Property = F4(
	function (property, title, url, status) {
		return {property: property, status: status, title: title, url: url};
	});
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{pid: $elm$core$Maybe$Nothing, properties: $elm$core$Maybe$Nothing, search: '', showingHelp: false},
		$elm$http$Http$get(
			{
				expect: A2(
					$elm$http$Http$expectJson,
					$author$project$Main$PropertiesReceived,
					A2(
						$elm$json$Json$Decode$map,
						A2(
							$elm$core$Basics$composeR,
							$elm$core$List$cons(
								{property: 'pointer-events', status: '', title: 'Scalable Vector Graphics 2', url: 'https://svgwg.org/svg2-draft/interact.html#PointerEventsProp'}),
							A2(
								$elm$core$Basics$composeR,
								$elm$core$List$filter(
									function (_v1) {
										var status = _v1.status;
										return (status !== 'ED') && (status !== 'NOTE');
									}),
...
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$browser$Browser$Events$onKeyDown(
		A2(
			...
			function (key) {
				return ($elm$core$String$length(key) === 1) ? $elm$json$Json$Decode$succeed(
					$author$project$Main$CharacterPressed(
						(key === ' ') ? '-' : key)) : $elm$json$Json$Decode$fail('not a character');
			},
			A2($elm$json$Json$Decode$field, 'key', $elm$json$Json$Decode$string)));
};
var $author$project$Main$NoOp = {$: 'NoOp'};
var $author$project$Main$PidReceived = function (a) {
	return {$: 'PidReceived', a: a};
};
var $author$project$Main$ResetSearch = {$: 'ResetSearch'};
	...
	function (search, properties) {
		...
		while (true) {
			if (properties.b) {
				...
				if (A2($elm$core$String$startsWith, search, first.property)) {
...
var $author$project$Main$resetSearchTimer = $elm$core$Process$sleep(1000);
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'PidReceived':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							pid: $elm$core$Maybe$Just(id)
						}),
					A2(
						$elm$core$Task$perform,
						function (_v1) {
							return $author$project$Main$ResetSearch;
						},
						$author$project$Main$resetSearchTimer));
			case 'CharacterPressed':
				var _char = msg.a;
				var currentSearch = _Utils_ap(model.search, _char);
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{search: currentSearch}),
					function () {
						var _v2 = model.properties;
						if (_v2.$ === 'Just') {
										...
										A2(
											...
											A2(
												...
												$elm$browser$Browser$Dom$getElement(
													A2($author$project$Main$match, currentSearch, properties))))),
										A2(
										$elm$core$Task$perform,
										$author$project$Main$PidReceived,
										function () {
											var _v4 = model.pid;
											if (_v4.$ === 'Just') {
												var pid = _v4.a;
												return A2(
													$elm$core$Task$andThen,
													function (_v5) {
														return $elm$core$Process$spawn($author$project$Main$resetSearchTimer);
													},
													$elm$core$Process$kill(pid));
											} else {
												return $elm$core$Process$spawn($author$project$Main$resetSearchTimer);
			...
			case 'PropertiesReceived':
				var result = msg.a;
				if (result.$ === 'Ok') {
					var properties = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								properties: $elm$core$Maybe$Just(properties)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
...
var $author$project$Main$HideHelp = {$: 'HideHelp'};
var $author$project$Main$ShowHelp = {$: 'ShowHelp'};
...
var $ursi$elm_css_colors$Css$Colors$black = A3($rtfeldman$elm_css$Css$rgb, 0, 0, 0);
...
var $author$project$Main$doubleCenter = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $author$project$Main$td = $rtfeldman$elm_css$Html$Styled$td(
	_List_fromArray(
		[
...
var $author$project$Main$view = function (model) {
	return {
		body: A2(
			...
			function () {
				var _v0 = model.properties;
				if (_v0.$ === 'Just') {
					var list = _v0.a;
					return _List_fromArray(
						[
							model.showingHelp ? A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Events$onMouseLeave($author$project$Main$HideHelp),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$backgroundColor($author$project$Main$helpColor),
											$author$project$Main$helpPlacement,
											$rtfeldman$elm_css$Css$padding(
											$rtfeldman$elm_css$Css$rem(1)),
											A3(
											...
											$rtfeldman$elm_css$Css$px(1),
											$rtfeldman$elm_css$Css$solid,
											$ursi$elm_css_colors$Css$Colors$black)
										]))
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Start typing to search the page.'),
									...
									$rtfeldman$elm_css$Html$Styled$text(' is intpreted as '),
									A2(
									$rtfeldman$elm_css$Html$Styled$kbd,
									_List_Nil,
									_List_fromArray(
									...
									$rtfeldman$elm_css$Html$Styled$text(' for convenience.')
								])) : A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Events$onMouseEnter($author$project$Main$ShowHelp),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$width($author$project$Main$helpIconSize),
											$rtfeldman$elm_css$Css$height($author$project$Main$helpIconSize),
											$rtfeldman$elm_css$Css$borderRadius($author$project$Main$helpIconSize),
											$rtfeldman$elm_css$Css$backgroundColor($author$project$Main$helpColor),
											$author$project$Main$helpPlacement,
											A3(
											$rtfeldman$elm_css$Css$border3,
											...
											$rtfeldman$elm_css$Css$solid,
											$ursi$elm_css_colors$Css$Colors$black),
											$author$project$Main$doubleCenter
										]))
								]),
							_List_fromArray(
								[
									...
									A2(
										...
										function (_v1) {
											...
											return A2(
												...
												_List_fromArray(
													[
														$rtfeldman$elm_css$Html$Styled$Attributes$id(property)
													]),
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$rtfeldman$elm_css$Html$Styled$text(property)
															])),
														$author$project$Main$td(
														_List_fromArray(
															[
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'size', '3rem')
										]),
									_List_Nil)
								]))
						]);
